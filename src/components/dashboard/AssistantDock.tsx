  ...
  return (
    <>
      ...
      <div
        ...
        role="dialog"
        aria-modal="true"
        aria-label="Agent Farmer AI assistant"
      ...
      >
        ...
        <div className="flex-1 flex min-h-0">
          ...
          <aside className="hidden md:flex w-[280px] shrink-0 flex-col border-r border-af-border bg-af-bg/50 p-5 overflow-y-auto">
            <h3 className="text-[15px] font-semibold text-af-ink">Try asking</h3>
      ...
      <button
        ...
        aria-label={isOpen ? "Close Agent Farmer AI" : "Open Agent Farmer AI"}
      ...
      >
        ...
        <span className="hidden sm:flex flex-col items-start leading-tight">
          <span className="text-meta font-semibold text-white">AI Assistant</span>
          <span className="text-[10px] text-af-sage/75">Ask me anything</span>
        </span>
        {!isOpen && (
